 ...
 * Executa o Prisma generate e cria arquivos faltantes se necessário
 */
...
// Criar enums.ts se não existir
if (!enumsExists) {
  console.warn("⚠ Arquivo enums.ts não encontrado, criando...");
...
`;
  ...
  try {
    ...
    console.log("✓ Arquivo enums.ts criado");
  } catch (error) {
